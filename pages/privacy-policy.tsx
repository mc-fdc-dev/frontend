    ...
    return (
        <Content title="プライバシーポリシー">
            ...
            <div className="border rounded-md p-8">
                ...
                <Article title="第6条（個人情報の開示）">
                    <ol className="pl-8 list-decimal">
                        <li>
                            <p>
                                当組織は，本人から個人情報の開示を求められたときは，本人に対し，遅滞なくこれを開示します。
                            ...
                            <ol className="pl-8 list-decimal">
                                ...
                                <li>当組織の業務の適正な実施に著しい支障を及ぼすおそれがある場合</li>
                ...
                <Article title="第7条（個人情報の訂正および削除）">
                    <ol className="pl-8 list-decimal">
                        <li>
                            ユーザーは，当組織の保有する自己の個人情報が誤った情報である場合には，当組織が定める手続きにより，
                            当社に対して個人情報の訂正，追加または削除（以下，「訂正等」といいます。）を請求することができます。
                        </li>
                        <li>
                            当組織は，ユーザーから前項の請求を受けてその請求に応じる必要があると判断した場合には，遅滞なく，当該個人情報の訂正等を行うものとします。
                        </li>
                        <li>
                            当組織は，前項の規定に基づき訂正等を行った場合，または訂正等を行わない旨の決定をしたときは遅滞なく，これをユーザーに通知します。
                        </li>
                    </ol>
                </Article>
                <Article title="第8条（個人情報の利用停止等）">
                    <ol className="pl-8 list-decimal">
                        <li>
                            当組織は，本人から，個人情報が，利用目的の範囲を超えて取り扱われているという理由，
