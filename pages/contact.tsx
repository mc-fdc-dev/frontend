    ...
    return (
        <div className='mt-4 mx-[10%]'>
            ...
            <div className='grid grid-cols-2'>
                ...
                <Content title="Form">
                    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSf9wAMFjgT9fQXQ-9jK-1h-0x-ah2RdDTBptSvL4f73FZ3UOA/viewform?embedded=true" width="630" height="539" frameBorder="0" marginHeight={0} marginWidth={0}>読み込んでいます…</iframe>
                </Content>
            </div>
        </div>
    )
